...
<html lang="ro">
    <head>
        <title>Engleză interactivă | Palatul Copiilor Bistrița</title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="grid">
            ...
            <div class="box4">
                <div class="grid2">
                    <div class="box21 engleza_top"></div>
                    <div class="box22">
                        <h2>Cercul de engleză interactivă</h2>
                        <h3 id="motto">MOTTO:<q> </q> - </h3>
                        <h3>PROFESOR: </h3>
                    </div>
                    <div class="box23 engleza_bottom"></div>
                </div>
            </div>
            <div class="box5">
