...
<html lang="ro">
    <head>
        <title>ABC-ul limbii germane | Palatul Copiilor Bistrița</title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="grid">
            ...
            <div class="box4">
                <div class="grid2">
                    <div class="box21 germana_top"></div>
                    <div class="box22">
                        <h2>Cercul de ABC al limbii germane</h2>
                        <h3 id="motto">MOTTO:<q> </q> - </h3>
                        <h3>PROFESOR: </h3>
                    </div>
                    <div class="box23 germana_bottom"></div>
                </div>
            </div>
            <div class="box5">
